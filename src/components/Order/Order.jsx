    ...
    <div className="flex flex-col px-40">
      <div className="flex flex-row items-center">
        ...
        <div className="flex flex-col pr-5">
          <p className="font-MorabbaMedium text-5xl pb-2">یکی از بهترین قهوه ها!</p>
          ...
          <button className="w-fit flex flex-row items-center rounded-full text-orange-300 border p-2 border-orange-300">
            <svg
